...
function LoginForm() {
  ...
  const errStyle: React.CSSProperties = {
    color: "#EF4444", fontSize: "13px", margin: "5px 0 8px", fontWeight: 500,
  };
  ...
  return (
    <div style={{
      ...
      {/* Logo — KRYROS all together, compact */}
      <div style={{ textAlign: "center", marginBottom: "22px" }}>
        <div style={{ display: "inline-flex", alignItems: "center", position: "relative" }}>
          {/* Small amber dot accent (like beem's orange square) */}
          <div style={{
            width: "10px", height: "10px", background: "#F59E0B",
            borderRadius: "2px", position: "absolute", top: "2px", left: "-4px",
          }} />
          <span style={{
            fontSize: "38px", fontWeight: 800, color: "#1FA89A",
      ...
      <form onSubmit={handleSubmit} style={{ width: "100%", maxWidth: "460px" }} noValidate>
        ...
        <div style={{ display: "flex", justifyContent: "center", margin: "18px 0" }}>
          <div style={{
            background: "#F4F7FB",
            border: `1.5px solid ${captchaError ? "#EF4444" : "#C8D3E0"}`,
            borderRadius: "4px", padding: "13px 18px",
            display: "flex", alignItems: "center", justifyContent: "space-between",
            width: "300px", gap: "16px",
          }}>
            <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
              <div
                onClick={() => { setCaptchaChecked(v => !v); setCaptchaError(false); }}
                role="checkbox" aria-checked={captchaChecked} tabIndex={0}
                onKeyDown={e => { if (e.key === " " || e.key === "Enter") { setCaptchaChecked(v=>!v); setCaptchaError(false); }}}
                style={{
                  width: "24px", height: "24px",
                  border: `2px solid ${captchaChecked ? "#1FA89A" : "#9CA3AF"}`,
                  borderRadius: "2px", cursor: "pointer",
                  background: captchaChecked ? "#1FA89A" : "white",
                  display: "flex", alignItems: "center", justifyContent: "center",
                  flexShrink: 0, transition: "all 0.15s",
                }}
              >
                {captchaChecked && (
                  <svg viewBox="0 0 12 10" width="13" height="13" fill="none">
            ...
            <div style={{ textAlign: "center", flexShrink: 0 }}>
              ...
              <p style={{ fontSize: "8.5px", color: "#94A3B8", lineHeight: 1.4, marginTop: "3px" }}>
                reCAPTCHA<br/><span style={{ fontSize: "7.5px" }}>Privacy · Terms</span>
              </p>
            </div>
          </div>
        </div>
        ...
        <button type="submit" disabled={loading} style={{
          ...
          background: loading ? "#5BBFB5" : "#1FA89A",
          ...
          {loading ? (
            <>
              <div style={{ width: "15px", height: "15px", border: "2px solid rgba(255,255,255,0.35)", borderTopColor: "white", borderRadius: "50%", animation: "spin 0.8s linear infinite" }} />
              Signing in...
            </>
          ) : "Sign In"}
        </button>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginTop: "16px" }}>
          <label style={{ display: "flex", alignItems: "center", gap: "7px", cursor: "pointer", fontSize: "13.5px", color: "#64748B", userSelect: "none" }}>
            <input type="checkbox" checked={rememberMe} onChange={e => setRememberMe(e.target.checked)}
              style={{ width: "15px", height: "15px", cursor: "pointer", accentColor: "#1FA89A" }} />
            Remember Me
          </label>
          <a href="#" onClick={e => e.preventDefault()} style={{ color: "#1FA89A", fontSize: "13.5px", textDecoration: "underline", fontWeight: 500 }}>
            Forgot Password
          </a>
        </div>
      </form>
