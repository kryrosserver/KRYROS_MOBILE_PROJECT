...
export default function FlashSalesPage() {
  ...
  const list = useMemo(
    () => (showAll ? products : products.filter(p => !!p.isFlashSale)),
    [products, showAll]
  );
    ...
    <div className=\"space-y-6\">
      <div className=\"flex items-center justify-between\">
        <div>
          ...
          <p className=\"text-slate-500\">Manage time-boxed promotions</p>
        </div>
      ...
      <div className=\"admin-card overflow-hidden\">
        <div className=\"overflow-x-auto\">
                  ...
                  <td>
                    <input
                      ...
                      onChange={(e) => {
                        ...
                        setProducts(prev => prev.map(x => x.id === p.id ? { ...x, flashSalePrice: val } : x));
                      }}
                    ...
                    <button
                      ...
                      onClick={async () => {
                        try {
                          ...
                          if (p.flashSalePrice !== undefined) {
                            payload.flashSalePrice = p.flashSalePrice;
                          }
          ...
          {!loading && !list.length && !error && <div className=\"p-4 text-sm text-slate-500\">No products</div>}
