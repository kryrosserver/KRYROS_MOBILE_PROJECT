...
export default function AgentsPage() {
  return (
    <div className="space-y-6 pb-20" style={{ color: "#111827", padding: "20px" }}>
      <div>
        <h2 className="text-2xl font-bold" style={{ color: "#111827" }}>Agents</h2>
        <p className="text-sm mt-1" style={{ color: "#4B5563" }}>Manage your agents</p>
      </div>
      <div className="admin-card flex flex-col items-center justify-center py-20 text-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm mt-1 max-w-sm" style={{ color: "#4B5563" }}>
            This feature is under development. The backend API endpoint for agents is not yet available.
          </p>
        </div>
      </div>
    </div>
