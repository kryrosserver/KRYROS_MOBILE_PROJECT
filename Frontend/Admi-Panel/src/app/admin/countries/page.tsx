    ...
    <div style={{ background: "#F5F6FA", minHeight: "100%", padding: "24px" }}>
        <div className="space-y-6" style={{ color: "#111827", padding: "20px" }}>
          <div className="flex items-center justify-between">
            <div>
              <h2 className="text-2xl font-bold whitespace-nowrap" style={{ color: "#111827" }}>Countries & Currencies</h2>
              <p className="text-sm mt-1" style={{ color: "#4B5563" }}>Manage multi-country support and exchange rates</p>
            </div>
