...
export default function CreditPage() {
  ...
  const loadAccounts = async () => {
    ...
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://kryrosbackend-hxfp.onrender.com/api'}/credit/all`, {
        headers: {
  ...
  const handleStatusUpdate = async (id: string, newStatus: string) => {
    try {
      const res = await fetch(`${process.env.NEXT_PUBLIC_API_URL || 'https://kryrosbackend-hxfp.onrender.com/api'}/credit/accounts/${id}/status`, {
        method: 'PUT',
        headers: {
