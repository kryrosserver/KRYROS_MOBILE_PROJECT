      ...
      <div ref={innerRef} style={{ background: "var(--bg-primary)", color: "var(--text-primary)", display: "flex", flexDirection: "column", minHeight: "100vh" }}>
        ...
        <header style={{ background: "var(--bg-secondary)", borderBottom: "1px solid var(--card-border)", height: 60, display: "flex", alignItems: "center", justifyContent: "space-between", padding: "0 24px", gap: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            ...
            <h1 style={{ fontSize: 17, fontWeight: 700, color: "var(--text-primary)", whiteSpace: "nowrap", margin: 0 }}>Credit Management</h1>
          </div>
          <div style={{ flex: 1, maxWidth: 340, position: "relative" }}>
            ...
            <input placeholder="Search users or email..."
        ...
        <div className="space-y-6" style={{ color: "var(--text-primary)", padding: "20px" }}>
          {/* Tab navigation */}
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div>
              <h2 style={{ fontSize: 22, fontWeight: 800, color: "var(--text-primary)", margin: 0 }}>Credit Management</h2>
              <p style={{ fontSize: 12, color: "var(--text-secondary)", marginTop: 4 }}>Manage applications and rules for installments</p>
            </div>
                ...
                <div className="space-y-4">
                  ...
                  <div className="pt-4 border-t border-slate-100">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Dynamic Specifications</label>
                      <button
                        onClick={() => setForm({ ...form, specifications: [...form.specifications, { key: "", value: "" }] })}
                        className="text-[10px] bg-slate-900 text-white px-2 py-1 rounded font-bold hover:bg-slate-800"
                      >
                        + Add Spec
                      </button>
                    </div>
                    ...
                    <div className="bg-slate-50 p-3 rounded-lg border border-slate-100 space-y-2">
                          ...
                          <div className="flex gap-1.5">
                            {currentCategoryAttributes.map(attr => (
                              <button
                                ...
                                className="px-2 py-0.5 bg-white border border-slate-200 rounded-md text-[9px] font-bold text-slate-500 hover:border-green-500 hover:text-green-600 transition-all"
                              >
                                + {attr}
                              </button>
                            ))}
                      ...
                      {form.specifications.length === 0 ? (
                        <p className="text-[10px] text-slate-400 text-center py-2 italic">No custom specs added.</p>
                      ) : (
                        form.specifications.map((spec, idx) => (
                          <div key={idx} className="flex gap-2 items-center">
                            <input
                              ...
                              className="admin-input h-8 text-[10px] flex-1"
                            />
                            <input
                              placeholder="Value"
                              value={spec.value}
            ...
            <div className="p-8 overflow-y-auto grid grid-cols-2 gap-8">
              <div className="space-y-5">
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {/* Dynamic Specifications Section (Edit) */}
                  <div className="pt-4 border-t border-slate-100">
                    <div className="flex items-center justify-between mb-2">
                      <label className="text-[10px] font-black text-slate-400 uppercase tracking-widest">Dynamic Specifications</label>
                      <button
                          ...
                          <div className="flex gap-1.5">
                            {currentEditCategoryAttributes.map(attr => (
                              <button
                                ...
                                className="px-2 py-0.5 bg-white border border-slate-200 rounded-md text-[9px] font-bold text-slate-500 hover:border-blue-500 hover:text-blue-600 transition-all"
                              >
                                + {attr}
                              </button>
                            ))}
                        ...
                        editForm.specifications.map((spec, idx) => (
                          <div key={idx} className="flex gap-2 items-center">
                            <input
                              ...
                              className="admin-input h-8 text-[10px] flex-1 bg-white"
                            />
                            <input
                              placeholder="Value"
                              value={spec.value}
                  ...
                  <button 
                    ...
                    onClick={async () => {
                      ...
                      try {
                        ...
                        if (editForm.specifications.length > 0) {
                          fd.append("specifications", JSON.stringify(editForm.specifications));
                        }
