...
export default function CitiesPage() {
  ...
  const stats = [
    { label: "Total Cities",    value: data.length,                         color: "#6366F1",    bg: "rgba(245,158,11,0.12)",  icon: Building2 },
          ...
          <div className="flex flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm mt-0.5" style={{ color: "#4B5563" }}>Manage city-level locations for your shipping network</p>
              </div>
            </div>
            <div className="flex items-center gap-3">
                ...
                <tbody>
                  {loading ? (
                    ...
                    <tr key={item.id}>
                      ...
                      <td><p className="text-sm" style={{ color: "#4B5563" }}>{item.state?.name || " "}</p></td>
                      <td>
