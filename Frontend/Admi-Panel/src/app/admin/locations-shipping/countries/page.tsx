...
import { Plus, Edit, Trash2, Search, RefreshCw, Globe, ChevronLeft, X, ChevronRight } from "lucide-react";
        ...
        <div className="space-y-6 pb-20" style={{ color: "var(--text-primary)" }}>
          ...
          <div className="flex flex-row items-center justify-between gap-4">
            <div className="flex items-center gap-3">
              <Link href="/admin/locations-shipping" className="h-9 w-9 rounded-xl flex items-center justify-center btn-secondary !px-0">
