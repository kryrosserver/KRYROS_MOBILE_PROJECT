...
export default function NewPage() {
  return (
    <div className="space-y-6 pb-20" style={{ color: "var(--text-primary)", padding: "20px" }}>
      <div>
        <h2 className="text-2xl font-bold" style={{ color: "var(--text-primary)" }}>New</h2>
        <p className="text-sm mt-1" style={{ color: "var(--text-secondary)" }}>Create a new new</p>
      </div>
      <div className="admin-card flex flex-col items-center justify-center py-20 text-center gap-4">
        ...
        <div>
          ...
          <p className="text-sm mt-1 max-w-sm" style={{ color: "var(--text-secondary)" }}>
            This feature is under development. The backend API endpoint is not yet available.
          </p>
        </div>
      </div>
    </div>
