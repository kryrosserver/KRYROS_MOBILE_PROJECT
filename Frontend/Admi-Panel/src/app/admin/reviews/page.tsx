    ...
    <div style={{ background: "#F8F9FA", minHeight: "100vh", padding: "24px" }}>
        ...
        {/* Body */}
          ...
          <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: 16 }}>
            <div>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: 6, marginTop: 6, fontSize: 12, color: TEXT2 }}>
                <span>Home</span><ChevronRight style={{ width: 13, height: 13 }} /><span style={{ color: "#6366F1" }}>Reviews</span>
              </div>
            </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
            {[
              { label: "Total Reviews", value: reviews.length, change: "+12.4%", up: true, color: "#6366F1", icon: MessageCircle },
          ...
          <div style={{ display: "flex", gap: 10, alignItems: "center" }}>
            <div style={{ position: "relative", flex: 1, maxWidth: 280 }}>
              ...
              <input placeholder="Search reviews..." value={searchTerm} onChange={e => setSearchTerm(e.target.value)}
                style={{ width: "100%", background: CARD, border: "1px solid #E5E7EB", borderRadius: 10, padding: "9px 12px 9px 30px", color: TEXT, fontSize: 13, outline: "none" }} />
            </div>
            <div style={{ position: "relative" }}>
              <select value={ratingFilter} onChange={e => setRatingFilter(e.target.value)}
                style={{ background: CARD, border: "1px solid #E5E7EB", borderRadius: 10, padding: "9px 32px 9px 12px", color: TEXT2, fontSize: 13, outline: "none", appearance: "none", cursor: "pointer" }}>
            ...
            <button onClick={fetchReviews} style={{ display: "flex", alignItems: "center", gap: 6, background: CARD, border: "1px solid #E5E7EB", borderRadius: 10, padding: "9px 16px", color: TEXT2, fontSize: 13, cursor: "pointer" }}>
          ...
          {loading ? (
            <div style={{ ...card, padding: 60, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", gap: 12 }}>
              <Loader2 style={{ width: 32, height: 32, color: "#6366F1" }} />
              ...
              {filteredReviews.map((review) => (
                <div key={review.id} style={{ ...card, padding: "18px", display: "flex", flexDirection: "column", gap: 14, transition: "box-shadow 0.15s" }}
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 12, paddingBottom: 14, borderBottom: "1px solid #E5E7EB" }}>
                    <div style={{ width: 48, height: 48, borderRadius: 10, overflow: "hidden", background: HOVER, border: "1px solid #E5E7EB", flexShrink: 0 }}>
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ fontSize: 10, fontWeight: 700, color: "#6366F1", textTransform: "uppercase", letterSpacing: "0.08em", marginBottom: 3 }}>Product Review</div>
                  ...
                  <div style={{ display: "flex", alignItems: "center", gap: 8, paddingTop: 12, borderTop: "1px solid #E5E7EB" }}>
                    <button disabled={updatingId === review.id}
                      ...
                      style={{ flex: 1, height: 36, borderRadius: 9, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", cursor: "pointer", border: "1px solid", transition: "all 0.15s",
                        ...
                        color: review.isApproved ? "#6366F1" : TEXT2,
                    ...
                    <button disabled={updatingId === review.id}
                      ...
                      style={{ flex: 1, height: 36, borderRadius: 9, display: "flex", alignItems: "center", justifyContent: "center", gap: 6, fontSize: 10, fontWeight: 700, textTransform: "uppercase", letterSpacing: "0.06em", cursor: "pointer", border: "1px solid", transition: "all 0.15s",
                        background: review.isFeatured ? "#6366F1" : HOVER,
                        color: review.isFeatured ? "#fff" : TEXT2,
                        borderColor: review.isFeatured ? "#6366F1" : BORDER,
                      }}>
