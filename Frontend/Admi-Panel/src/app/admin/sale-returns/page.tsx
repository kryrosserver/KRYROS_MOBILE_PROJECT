  ...
  return (
    <div className="space-y-6 pb-20" style={{ color: "var(--text-primary)" }}>
      <div className="flex items-center justify-between">
        <div>
          <h1 className="text-2xl font-bold whitespace-nowrap" style={{ color: "var(--text-primary)" }}>Sale Returns</h1>
      ...
      <div className="admin-card !p-0 overflow-hidden">
        <div className="p-4" style={{ borderBottom: "1px solid var(--card-border)" }}>
          <div className="relative max-w-md">
            ...
            <input placeholder="Search sale returns..." value={search} onChange={e => setSearch(e.target.value)} className="admin-input pl-10 w-full" />
          </div>
        </div>
        <div className="overflow-x-auto">
          <table className="admin-table">
            <thead>
              <tr>
                <th>Return #</th><th>Client</th><th>Date</th>
