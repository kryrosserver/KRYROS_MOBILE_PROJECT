    ...
    return (
      <div className="min-h-screen flex flex-col items-center justify-center bg-slate-50 p-4 text-center">
        <div className="bg-white p-8 rounded-2xl shadow-sm border border-slate-100 max-w-md w-full">
          ...
          <Button onClick={() => window.location.href = '/credit'} className="bg-green-600 w-full hover:bg-green-700 h-12 font-bold">
            Back to Credit Page
          </Button>
        </div>
      </div>
    ...
    <div className="min-h-screen bg-slate-50 py-8 md:py-12">
      <div className="container-custom">
        ...
        <div className="flex flex-wrap items-center gap-2 mb-6 text-xs font-bold uppercase tracking-wider text-slate-400">
          <a href="/credit" className="hover:text-blue-600 transition-colors">Credit</a>
